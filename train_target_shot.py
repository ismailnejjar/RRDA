...
def train(args, model, train_dataloader, test_dataloader, optimizer, epoch_idx=0.0):
    ...
    for imgs_train, _, imgs_label, imgs_idx in tqdm(train_dataloader, ncols=60):
        ...
        loss = 0.3*nn.CrossEntropyLoss()(outputs_test_known, torch.from_numpy(pred).long().cuda())
...
def main(args):
    ...
    save_dir = os.path.join(this_dir, "checkpoints_shot", args.dataset, "s_{}_t_{}".format(args.s_idx, args.t_idx),
